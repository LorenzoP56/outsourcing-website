...
export default function AffidatiServizi() {
  return (
    <section className="lg:px-32 lg:py-16 flex lg:flex-row flex-col gap-8 px-8 py-16 items-center justify-center gap-16" style={{ backgroundImage: 'url(/images/ChiSiamo/bgAffidati.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
