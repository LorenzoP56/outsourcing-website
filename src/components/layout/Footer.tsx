...
export default function Footer() {
  ...
  return (
    <footer ref={sectionRef} className="py-16" style={{ backgroundColor: COLORS.TEXT_TITLE, color: COLORS.TEXT }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className={`lg:col-span-1 transition-all duration-1000 ease-out gap-2 flex flex-col ${
            ...
            <Link href="/" className="inline-block mb-4">
              {/* TODO: Add marketingRentLungo.webp to public/images */}
              <div className="h-12 px-4 bg-white/10 rounded flex items-center justify-center">
